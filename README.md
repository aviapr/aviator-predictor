...
1. Download the APK file from our [releases page](https://aviatorpredictor.org).
...
This project is licensed under the MIT License. For more details, see the [LICENSE](https://aviatorpredictor.org) file.
